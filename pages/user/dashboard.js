    ...
    <div className="justify-center items-center text-center gap-8 flex flex-row">
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/5 px-4 py-4 bg-grey mt-6 shadow-lg rounded-lg dark:bg-gray-800">
        <div className="justify-end items-end text-right gap-8 flex flex-row mb-4 pb-4">
          <Link href={"/about"}>
            <Image height={40} width={40} src="/questionmark.png" alt="Question mark symbol" className={"px-4 ml-0 rounded-full border-gold border-2 inline float-left text-left items-end justify-end"} />
          </Link>
          <button
            type="button"
        ...
        <div className="px-2 inline pt-4 align-middle">
          <Image height={30} width={30} src={ensAvatar ? ensAvatar : "/metamask.svg"} alt="Account avatar" className={"px-5"} />
        </div>
        <div className="my-4">
          ...
          <Image height={30} width={30} src="/hash.png" alt="Hash symbol" className={"px-4 rounded-full border-gold border-2 inline"} id="address" data-tooltip-content={tooltipState} />
        </div>
